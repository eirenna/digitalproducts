...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > 200) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-header-wrap').addClass('ba-scrolled');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-header-wrap').removeClass('ba-scrolled');
  }
});
var worksSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-works-slider');
worksSlider.slick({
  slide: '.ba-work',
  infinite: true,
  dots: true,
...
var teamSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-team-slider');
teamSlider.slick({
  slide: '.ba-teammate',
  infinite: true,
  dots: false,
...
function initMap() {
  ...
  var baMap = new google.maps.Map(document.getElementById('ba-map'), {
    center: mapCenter,
    zoom: 13,
    styles: [{
      "featureType": "water",
...
module.exports = __webpack_require__(/*! d:\academy\academy\exam3\src\assets\js\app.js */"./src/assets/js/app.js");
